...
class ModelStorageService:
    ...
    def create_demo_model(self):
        """Создать демо модель для тестирования"""
        try:
            ...
            X = np.random.rand(1000, 12)  # 12 признаков
            y = np.random.randint(0, 2, 1000)  # Бинарная классификация
            ...
            self.set_current_model(filename)
            
            logger.info("Demo model created and set as current")
            return filename
